...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`w-[90vw] h-[calc(0.1*100vh)] md:hidden flex flex-row items-center justify-between px-[1rem] py-[2rem] my-5 rounded-xl bg-[#171b2e] overflow-hidden transition-all duration-700 ease-in-out`}
      >
        <Link to="/">
        ...
        >
          <div className="-z-10 w-60 h-[100vh] bg-[#171b2e] flex flex-col justify-between">
            <div className="flex flex-col transition duration-700 ease-in-out">
              ...
              >
                <img src={user} alt="user" className="h-5 w-5" />
                <h1 className="text-[#fff] text-[1.3rem] font-semibold">
                  Profile
                </h1>
              </div>
              <nav className="flex flex-col px-[2rem]">
