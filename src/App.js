...
function App() {
  ...
  return (
    <div
      className={`bg-[url('https://i.postimg.cc/XqRvr2np/background.png')] bg-cover focus:bg-none bg-no-repeat bg-fixed h-[100vh] w-[100vw] mt-0 mx-0 overflow-x-hidden scrollbar-hide`}
    >
      ...
      location.pathname === "/auth/login" ? (
        ...
        <div className="w-[100vw] h-[100vh] flex md:flex-row flex-col justify-start items-center">
          <Navbar />
